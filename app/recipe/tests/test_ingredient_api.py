...
def create_user(email="example@bracu.ac.bd", password="testpass"):
...
class PrivateIngredientAPITests(TestCase):
    ...
    def test_ingredient_limited_to_user(self):
        """Test list of ingredeients is limited to authenticated user."""
        user2 = create_user(email='test@bracu.ac.bd', password='testpass')
